...
class ArticleHorizontalAdapter(val articleList: List<Article>) : RecyclerView.Adapter<ArticleHorizontalAdapter.ViewHolder>() {

    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): ViewHolder {
        val v = LayoutInflater.from(p0.context).inflate(R.layout.article_horizontal_item, p0, false)

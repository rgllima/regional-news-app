...
class ArticleAuthorsViewModelFactory constructor(private val repository: ArticleRepository,
                                                 private val application: Application): ViewModelProvider.Factory {
    override fun <T : ViewModel?> create(modelClass: Class<T>): T =
        with(modelClass){
            when {
                isAssignableFrom(ArticleAuthorsViewModel::class.java) ->
                    ArticleAuthorsViewModel(repository, application)
                else ->
